<template>
  ...
  <div class="px-5 py-4">
    <RequestGate
      ...
      :loaded="expensePermissionsLoaded && myEmployeeLoaded"
      :permitted="expenseCan.read"
      what="see expense claims"
      @retry="reloadExpensePermissions()"
    >
      <EmployeeRequired
        :employee="employee"
        :access="expenseCan.employee_access"
        forbids="so expenses can't be claimed against it"
        requires="Expenses are claimed against an employee"
      >
