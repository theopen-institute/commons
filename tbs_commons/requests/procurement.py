...
The budget readout has its own module (`tbs_commons.requests.budget`); what
...
from tbs_commons.requests.procurement_workflow import APPROVER_FIELD
from tbs_commons.requests.procurement_workflow import approver_roles as _approver_roles
...
class Procurement(approvals.RequestType):
	...
	approver_query = "tbs_commons.requests.procurement.get_procurement_approvers"
...
def _add_procurement_costs(requests: list[dict]) -> None:
	...
	"""
	from tbs_commons.requests.budget import request_summary
