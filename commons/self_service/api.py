"""Whitelisted endpoints for the self-service section of the Commons frontend.
...
`commons.self_service.registry`. Nothing below names a doctype, and the app
...
and this app's gate in `commons.safer_permissions` -- applies to it without
